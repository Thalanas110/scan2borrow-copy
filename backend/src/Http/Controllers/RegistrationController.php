    ...
    public function begin(ServerRequest $request): JsonResponse
    {
        ...
        try {
            $result = $this->registrations->begin(new RegistrationRequest(
                barcode: $this->string($body, 'barcode'),
                firstname: $this->string($body, 'firstname'),
                middlename: $this->string($body, 'middlename'),
                lastname: $this->string($body, 'lastname'),
                role: $this->string($body, 'role'),
                department: $this->string($body, 'department'),
                position: $this->string($body, 'position'),
                course: $this->string($body, 'course'),
                yearLevel: $this->string($body, 'year_level'),
