    ...
    public function all(): array
    {
        return array_values(array_map(
            ...
            [
                ...
                $this->endpoint('GET', '/api/student/recommendations', 'Books', 'Read student recommendations', 'Returns up to five available books ranked from the authenticated student’s recent searches, with newest-book fallback for a cold start.', 'Student only', [], 'JSON recommended books and a personalized flag.'),
                $this->endpoint('GET', '/api/teacher/recommendations', 'Books', 'Read teacher recommendations', 'Returns up to five available books ranked from the authenticated teacher’s recent searches, with newest-book fallback for a cold start.', 'Teacher only', [], 'JSON recommended books and a personalized flag.'),
                $this->endpoint('POST', '/api/student/search-history', 'Books', 'Record a student search', 'Records one deliberate non-empty catalog search for later content-based recommendations.', 'Student only', ['Body: search, csrf'], 'JSON confirmation that the search was recorded.'),
                $this->endpoint('POST', '/api/teacher/search-history', 'Books', 'Record a teacher search', 'Records one deliberate non-empty catalog search for later content-based recommendations.', 'Teacher only', ['Body: search, csrf'], 'JSON confirmation that the search was recorded.'),
                ...
                $this->endpoint('POST', '/api/student/return', 'Borrower', 'Submit a return request', 'Submits a return request by barcode or transaction code for librarian verification; staff approval completes the return.', 'Student or teacher', ['Body: action=return_unified, return_input, csrf'], 'JSON return request result.'),
                ...
                $this->endpoint('GET', '/api/guest/borrowed', 'Guest', 'Read active guest loans', 'Returns the visitor’s released books, including returns awaiting librarian verification.', 'Guest session', [], 'JSON active visitor loans.'),
                ...
                $this->endpoint('GET', '/api/staff/return-approvals', 'Staff', 'List pending return requests', 'Returns borrower and guest return requests waiting for physical verification by staff.', 'Admin or librarian', [], 'JSON pending return requests.'),
                ...
                $this->endpoint('POST', '/api/staff/return-action', 'Staff', 'Approve or reject a return request', 'Approves a physically verified return or rejects it while leaving the loan active.', 'Admin or librarian', ['Body: type, id, action, note, csrf'], 'JSON decision result.'),
