...
final class PdoStaffRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->pdo->exec('CREATE TABLE users (id INTEGER PRIMARY KEY, barcode TEXT, firstname TEXT, lastname TEXT, department TEXT, position TEXT, course TEXT, year_level TEXT, email TEXT, role TEXT, password_hash TEXT, status TEXT)');
        ...
        $this->pdo->exec("INSERT INTO users VALUES (1, 'STAFF-1', 'Ada', 'Lovelace', 'Library', 'Librarian', NULL, NULL, 'ada@example.test', 'librarian', NULL, 'active')");
        $this->pdo->exec("INSERT INTO users VALUES (2, 'STU-1', 'Grace', 'Hopper', 'IT', NULL, 'CS', '4', 'grace@example.test', 'student', NULL, 'active')");
