...
final class PageRouteTableTest extends TestCase
{
    ...
    {
        $table = new PageRouteTable(dirname(__DIR__, 3) . DIRECTORY_SEPARATOR . 'frontend');
        foreach (['/login', '/register', '/verify-otp', '/student/dashboard', '/student/search', '/teacher/dashboard', '/staff/dashboard', '/staff/books', '/staff/barcodes/print', '/guest/dashboard', '/guest/registration', '/guest/receipt', '/admin/api-docs'] as $path) {
