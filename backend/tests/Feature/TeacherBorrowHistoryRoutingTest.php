...
{
    public function testTeacherPagesAreTeacherProtectedAndResolveToTeacherTemplates(): void
    {
        ...
        self::assertStringContainsString('features' . DIRECTORY_SEPARATOR . 'teacher' . DIRECTORY_SEPARATOR . 'pages', $table->forPath('/teacher/borrow')->templatePath());
        self::assertStringContainsString('features' . DIRECTORY_SEPARATOR . 'teacher' . DIRECTORY_SEPARATOR . 'pages', $table->forPath('/teacher/history')->templatePath());
    }
