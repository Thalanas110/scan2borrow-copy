...
final class CleanRouteMatrixTest extends TestCase
{
    ...
    public function testEveryCurrentRouteIsListedInTheFrontendMatrix(): void
    {
        ...
        foreach ([
            ...
            '/student/dashboard', '/student/search', '/student/history', '/student/activity', '/receipt',
            '/teacher/dashboard', '/teacher/borrow', '/teacher/history', '/teacher/activity', '/guest/dashboard', '/guest/profile',
