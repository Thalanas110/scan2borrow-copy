class GuestReturnBookController {
  ...
  submit(event) {
    ...
    fetch("/scan2borrow/api/guest/return", { method: "POST", body })
      ...
      .then((response) => {
        ...
        box.textContent = response.ok
          ...
          : response.errors?.[0] || "Request failed.";
      })
      .catch(() => {
...
window.addEventListener("DOMContentLoaded", () => {
  if (document.getElementById("returnForm")) new GuestReturnBookController();
});
